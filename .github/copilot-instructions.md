...
- **Output Folder**: {project-root}/_spec
- **Planning Artifacts**: {project-root}/_spec/planning-artifacts
- **Implementation Artifacts**: {project-root}/_spec/implementation-artifacts
